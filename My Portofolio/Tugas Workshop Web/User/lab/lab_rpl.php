            ...
            <div class="row">
                <div class="col-lg" >
                    ...
                    <table border = "0" class = "row justify-content-justify">
                        ...
                        <?php
                            $query_bio = mysqli_query($db,"SELECT * FROM dosen where kode_lab='L001' AND nidn=30037701");
                            while($row = mysqli_fetch_array($query_bio)){
                                ...
                                <tr><td><p><span>JAFUNG</span>&nbsp;</p></td>
                                    <td align="center"><p>:</p></td>
                                    <td><p>&nbsp;'. $row["jafung"] .'<a href="#profil1" data-toggle="modal">&nbsp;&nbsp;<i class="fa fa-chevron-circle-right"></a></p></td>
                                </tr>';
                            }
                        ?>
                    </table>
