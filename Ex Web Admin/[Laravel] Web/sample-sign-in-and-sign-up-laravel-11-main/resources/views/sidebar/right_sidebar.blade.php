<div x-show="$store.global.isRightSidebarExpanded" @keydown.window.escape="$store.global.isRightSidebarExpanded = false">
    ...
    <div class="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
        <div x-data="{activeTab:'tabHome'}"
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-3 space-y-3 px-2">
                        <div
                            ...
                            <img src="assets/images/object/object-18.jpg" class="size-20 rounded-lg object-cover object-center" alt="image">
                        </div>
                        ...
                        <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                            ...
                            <img src="assets/images/object/object-2.jpg" class="size-20 rounded-lg object-cover object-center" alt="image">
                        </div>
                        ...
                        <div
                            ...
                            <img src="assets/images/object/object-1.jpg" class="size-20 rounded-lg object-cover object-center" alt="image">
                        </div>
                    </div>
                </div>
            ...
            <div x-show="activeTab === 'tabActivity'" x-transition:enter="transition-all duration-500 easy-in-out" x-transition:enter-start="opacity-0 [transform:translate3d(0,1rem,0)]" x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]"
                class="is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
