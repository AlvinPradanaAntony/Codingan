                        ...
                        <div class="col-12">
                            <form method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txt_keg" value=""
                                        placeholder="isi judul kegiatan">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Tanggal Kegiatan</label>
                                    <input type="date" class="form-control" name="txt_date" value="">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Deskripsi</label>
                                    <textarea class="form-control" name="txt_desk" rows="3"></textarea>
                                </div>
                                <div class="form-group">
