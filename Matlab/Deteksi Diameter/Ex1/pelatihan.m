...
% net1 = train(net1,ciri_buruk');
% net2 = train(net2,ciri_baik');
% 
...
% pfn1 = dist(wnet1,[ciri_buruk;ciri_baik]');
% pfn2 = dist(wnet2,[ciri_buruk;ciri_baik]');
% 
